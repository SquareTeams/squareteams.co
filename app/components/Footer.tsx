...
export default function Footer() {
  return (
    <div className="bg-gray-100 text-black">
      <div className="container mx-auto text-left max-w-screen-lg py-20 items-center grid grid-cols-2">
        <div className="footer-social-section">
          <ul class="list-none space-y-4">
            ...
            <li className="uppercase opacity-70 hover:opacity-100 text-2xl md:text-4xl"><a href="" target="_blank">Follow Our Socials</a></li>
        ...
        <div className="footer-info-section">
          <div className="flex flex-col items-end">
            <div className="w-auto">
              <img src="/assets/square_md.png" alt="Logo" className="h-12 md:h-20 w-auto mb-12"/>
